  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <section style={{
        ...
        {/* Background weight plates — decorative */}
        <WeightPlate style={{
        ...
        <div style={{
          ...
          {[
            ...
            <div key={s.label} style={{
              ...
              padding: '8px 40px',
              borderRight: i < arr.length - 1 ? '1px solid #292524' : 'none',
            }}>
              <span style={{
                fontSize: '32px', fontWeight: 900, color: '#dc2626',
                letterSpacing: '-1px', lineHeight: 1,
              }}>{s.value}</span>
              <span style={{
                fontSize: '10px', color: '#78716c', fontWeight: 700,
      ...
      <section style={{
        ...
        <div style={{ textAlign: 'center' }}>
          <p style={{
            margin: 0, fontSize: '11px', color: '#57534e',
            fontWeight: 700, letterSpacing: '3px', textTransform: 'uppercase', marginBottom: '8px',
          }}>The Coach That Never Quits</p>
          <p style={{
            margin: 0, fontSize: '22px', fontWeight: 900, color: '#fafaf9',
            textTransform: 'uppercase', letterSpacing: '-0.5px',
          }}>AI that trains like a pro,<br/>talks like a coach.</p>
        </div>
      ...
      <section style={{
        ...
        {features.map((f, i) => (
          <div key={f.title} style={{
            ...
            <p style={{ margin: 0, fontSize: '14px', color: '#78716c', lineHeight: 1.7 }}>
              {f.desc}
            </p>
          </div>
        ))}
      ...
      {/* ── BOTTOM CTA ────────────────────────────────────────────────────── */}
      <section style={{
        background: `${TEXTURE_BG}, linear-gradient(135deg, #1c0a0a 0%, #0c0b0b 100%)`,
        borderTop: '1px solid #292524',
        padding: '72px 24px',
        textAlign: 'center',
      }}>
